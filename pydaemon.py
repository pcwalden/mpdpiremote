...
__revision__ = "$Id: pydaemon.py,v 1.1 2015/08/10 14:54:15 pwalden Exp $"
__version__ = "0.2"
...
##      maxfd = MAXFD
   maxfd = 2 # only close 0-2 std in, out and err
...
if __name__ == "__main__":
   ...
   # The code, as is, will create a new file in the user home directory, when
   ...
   open(os.path.expanduser('~/createDaemon.log'), "w").write(procParams + "\n")
